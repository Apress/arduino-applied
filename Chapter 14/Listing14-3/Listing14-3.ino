/*******************************************************************************
 * Sketch name: predicting colour with colour recognition sensor
 * Description: extension of Listing 14-2 to "predict" the colour of the scanned object
...
unsigned int colour;
String text;
     if (R>220 && G<150) {colour = 0xF800; text = "RED      ";}
else if (G>120 && R<100) {colour = 0x07E0; text = "GREEN    ";}
else if (B>170 && R<150) {colour = 0x001F; text = "BLUE     ";} 
else if (R>200 && G>170) {colour = 0xFFE0; text = "YELLOW   ";}
else if (R>200 && B>200) {colour = 0xF81F; text = "MAGENTA  ";}
else if (G>170 && B>200) {colour = 0x07FF; text = "CYAN     ";}
else {colour = 0xFFFF; text = "no colour";}
tft.setTextSize(2);
tft.setCursor(20,20);
