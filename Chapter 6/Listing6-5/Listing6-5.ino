/*******************************************************************************
 * Sketch name: second shift register control of digits
 * Description: control temperature and time display with two 74HC595 shift registers
...
//  for (int i = 0; i<4; i++) digitalWrite(digits[i], 1);   // turn all digits off, digit states are HIGH
  ...
  shiftOut(dataPin, clockPin, MSBFIRST, digits[d]);     // data from 2nd shift register
